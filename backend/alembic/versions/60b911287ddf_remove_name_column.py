...
Revision ID: 60b911287ddf
Revises: eb72b18e840f
Create Date: 2025-10-02 19:28:04.808689
...
revision: str = '60b911287ddf'
down_revision: Union[str, Sequence[str], None] = 'eb72b18e840f'
...
def upgrade() -> None:
    ...
    op.drop_column('itp', 'name')
    op.create_unique_constraint(None, 'itp_mkd', ['id'], schema='lctdora')
    op.drop_constraint(op.f('itp_mkd_id_mkd_fkey'), 'itp_mkd', type_='foreignkey')
    op.drop_constraint(op.f('itp_mkd_id_itp_fkey'), 'itp_mkd', type_='foreignkey')
    op.create_foreign_key(None, 'itp_mkd', 'mkd', ['id_mkd'], ['id'], source_schema='lctdora', referent_schema='lctdora')
    op.create_foreign_key(None, 'itp_mkd', 'itp', ['id_itp'], ['id'], source_schema='lctdora', referent_schema='lctdora')
    op.create_unique_constraint(None, 'mkd', ['id'], schema='lctdora')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'itp_mkd', schema='lctdora', type_='foreignkey')
    op.drop_constraint(None, 'itp_mkd', schema='lctdora', type_='foreignkey')
    op.create_foreign_key(op.f('itp_mkd_id_itp_fkey'), 'itp_mkd', 'itp', ['id_itp'], ['id'])
    op.create_foreign_key(op.f('itp_mkd_id_mkd_fkey'), 'itp_mkd', 'mkd', ['id_mkd'], ['id'])
    op.drop_constraint(None, 'itp_mkd', schema='lctdora', type_='unique')
    op.add_column('itp', sa.Column('name', sa.TEXT(), autoincrement=False, nullable=False))
