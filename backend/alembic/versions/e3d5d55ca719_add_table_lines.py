...
Revision ID: e3d5d55ca719
Revises: 92e7da0abfd0
Create Date: 2025-10-04 21:02:30.629582
...
revision: str = 'e3d5d55ca719'
down_revision: Union[str, Sequence[str], None] = '92e7da0abfd0'
...
def upgrade() -> None:
    ...
    sa.Column('itp_id', sa.Text(), nullable=False),
    ...
    sa.Column('status', sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False), nullable=False),
    sa.Column('layout_index', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.alter_column('itp', 'id',
               ...
               nullable=True)
    op.alter_column('itp', 'layout_index',
    ...
    op.drop_index('idx_lines_geometry', table_name='lines', schema='lctdora', postgresql_using='gist')
    op.drop_table('lines', schema='lctdora')
    # ### end Alembic commands ###
