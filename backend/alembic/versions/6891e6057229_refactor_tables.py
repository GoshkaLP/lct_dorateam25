...
Revision ID: 6891e6057229
Revises: e3d5d55ca719
Create Date: 2025-10-04 22:24:46.231737
...
revision: str = '6891e6057229'
down_revision: Union[str, Sequence[str], None] = 'e3d5d55ca719'
...
def upgrade() -> None:
    ...
    op.alter_column('itp', 'district',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('itp', 'region',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('itp', 'dispatcher',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('itp', 'geometry',
               ...
               nullable=False)
    op.alter_column('itp', 'status',
               existing_type=sa.TEXT(),
               type_=sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False),
               nullable=False)
    op.alter_column('itp', 'id',
               existing_type=sa.TEXT(),
               nullable=False)
    op.create_unique_constraint(None, 'itp', ['id'], schema='lctdora')
    op.alter_column('lines', 'itp_id',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('lines', 'geometry',
               existing_type=geoalchemy2.types.Geometry(geometry_type='LINESTRING', srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True),
               nullable=False)
    op.alter_column('lines', 'status',
               existing_type=sa.TEXT(),
               type_=sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False),
               nullable=False)
    op.alter_column('lines', 'layout_index',
    ...
    op.alter_column('lines', 'id',
               existing_type=sa.TEXT(),
               nullable=False)
    op.create_unique_constraint(None, 'lines', ['id'], schema='lctdora')
    op.alter_column('mkd', 'itp_id',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'district',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'region',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'street',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'index',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'house_number',
               existing_type=sa.TEXT(),
               nullable=False)
    op.alter_column('mkd', 'residents_amount',
               existing_type=sa.BIGINT(),
               type_=sa.Integer(),
               nullable=False)
    op.alter_column('mkd', 'floors_amount',
               existing_type=sa.BIGINT(),
               type_=sa.Integer(),
               nullable=False)
    op.alter_column('mkd', 'geometry',
               ...
               nullable=False)
    op.alter_column('mkd', 'status',
               existing_type=sa.TEXT(),
               type_=sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False),
               nullable=False)
    op.alter_column('mkd', 'id',
               existing_type=sa.TEXT(),
               nullable=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'mkd', schema='lctdora', type_='unique')
    op.alter_column('mkd', 'id',
               existing_type=sa.TEXT(),
               nullable=True)
    op.alter_column('mkd', 'status',
               existing_type=sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False),
               type_=sa.TEXT(),
               nullable=True)
    op.alter_column('mkd', 'geometry',
               existing_type=geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True),
    ...
    op.alter_column('mkd', 'itp_id',
               existing_type=sa.TEXT(),
               nullable=True)
    op.drop_constraint(None, 'lines', schema='lctdora', type_='unique')
    op.alter_column('lines', 'id',
               existing_type=sa.TEXT(),
               nullable=True)
    op.alter_column('lines', 'layout_index',
    ...
    op.alter_column('lines', 'itp_id',
               existing_type=sa.TEXT(),
               nullable=True)
    op.drop_constraint(None, 'itp', schema='lctdora', type_='unique')
    op.alter_column('itp', 'id',
               existing_type=sa.TEXT(),
               nullable=True)
    op.alter_column('itp', 'status',
