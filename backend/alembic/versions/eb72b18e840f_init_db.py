...
Revision ID: eb72b18e840f
Revises: 
Create Date: 2025-10-02 02:38:40.243778
...
def upgrade() -> None:
    ...
    op.create_table('itp_mkd',
    sa.Column('id_itp', sa.Text(), nullable=False),
    sa.Column('id_mkd', sa.Text(), nullable=False),
    sa.Column('status_itp', sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False), nullable=False),
    sa.Column('status_mkd', sa.Enum('ORANGE', 'YELLOW', 'GREEN', 'UNKNOWN', name='objectstatus', native_enum=False), nullable=False),
    sa.Column('season', sa.Text(), nullable=False),
    sa.Column('week_number', sa.Integer(), nullable=False),
    sa.Column('confidence_interval_feature_1', sa.Float(), nullable=True),
    sa.Column('confidence_interval_feature_2', sa.Float(), nullable=True),
    sa.Column('id', sa.Text(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['id_itp'], ['lctdora.itp.id'], ),
    sa.ForeignKeyConstraint(['id_mkd'], ['lctdora.mkd.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
    schema='lctdora'
    )
...
def downgrade() -> None:
    ...
    op.drop_table('itp_mkd', schema='lctdora')
    op.drop_index('idx_mkd_geometry', table_name='mkd', schema='lctdora', postgresql_using='gist')
    op.drop_table('mkd', schema='lctdora')
    op.drop_index('idx_itp_geometry', table_name='itp', schema='lctdora', postgresql_using='gist')
    op.drop_table('itp', schema='lctdora')
    # ### end Alembic commands ###
