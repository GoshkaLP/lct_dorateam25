...
Revision ID: 0fc9359b4c87
Revises: 60b911287ddf
Create Date: 2025-10-02 21:22:11.785022
...
revision: str = '0fc9359b4c87'
down_revision: Union[str, Sequence[str], None] = '60b911287ddf'
...
def upgrade() -> None:
    ...
    op.add_column('mkd', sa.Column('index', sa.Text(), nullable=False))
    op.add_column('mkd', sa.Column('residents_amount', sa.Integer(), nullable=False))
    op.add_column('mkd', sa.Column('floors_amount', sa.Integer(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('mkd', 'floors_amount')
    op.drop_column('mkd', 'residents_amount')
    op.drop_column('mkd', 'index')
